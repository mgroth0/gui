...
object FXActionAbilitiesService: ActionAbilitiesService {
    override fun confirm(s: String): Boolean = ensureInFXThreadInPlace {
        var ok = false
    ...
    override fun yesOrNo(s: String): YesOrNo = ensureInFXThreadInPlace {
        var ok: YesOrNo? = null
        alert(
            CONFIRMATION,
            s
    ...
    override fun openFile(prompt: String): String? = ensureInFXThreadInPlace {

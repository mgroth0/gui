...
private fun StageWrapper.saveGeometryIfValid(key: String) {
    ...
    MattGeneralStateWindowsNode.nodeByWindowKey[key].geometry.value =
        DoubleBox(
            x,
            y,
            width,
...
private fun StageWrapper.loadGeometry(key: String) =
    apply {
...
private fun StageWrapper.loadGeometry(geom: DoubleBox) =
    apply {
        x = geom.x
        y = geom.y
        width = geom.width
